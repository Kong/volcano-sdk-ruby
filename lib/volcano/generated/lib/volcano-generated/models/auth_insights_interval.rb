...
module Volcano::Generated
  class AuthInsightsInterval
    DAY = "day".freeze
    WEEK = "week".freeze
    MONTH = "month".freeze

    def self.all_vars
      @all_vars ||= [DAY, WEEK, MONTH].freeze
    end
    ...
    def build_from_hash(value)
      return value if AuthInsightsInterval.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #AuthInsightsInterval"
    end
  end
end
