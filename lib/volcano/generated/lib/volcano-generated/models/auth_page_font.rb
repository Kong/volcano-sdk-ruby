...
module Volcano::Generated
  class AuthPageFont
    ...
    HUMANIST = "humanist".freeze
    GEOMETRIC = "geometric".freeze
    SLAB = "slab".freeze
    MONO = "mono".freeze

    def self.all_vars
      @all_vars ||= [SYSTEM, HUMANIST, GEOMETRIC, SLAB, MONO].freeze
    end
    ...
    def build_from_hash(value)
      return value if AuthPageFont.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #AuthPageFont"
    end
  end
end
