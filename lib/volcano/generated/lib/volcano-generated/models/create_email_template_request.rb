...
module Volcano::Generated
  class CreateEmailTemplateRequest < ApiModelBase
    ...
    # HTML template body. Available placeholders: - {{.Token}} - The confirmation/reset token - {{.ProjectName}} - The project name - {{.Email}} - User's email address 
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Volcano::Generated::CreateEmailTemplateRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Volcano::Generated::CreateEmailTemplateRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @text_body.nil?
        invalid_properties.push('invalid value for "text_body", text_body cannot be nil.')
      end
    ...
    def valid?
      ...
      template_type_validator = EnumAttributeValidator.new('String', ["welcome", "confirmation", "password_reset", "password_changed"])
      return false unless template_type_validator.valid?(@template_type)
      return false if @subject.nil?
      return false if @html_body.nil?
      return false if @text_body.nil?
      true
    end
    ...
    def template_type=(template_type)
      validator = EnumAttributeValidator.new('String', ["welcome", "confirmation", "password_reset", "password_changed"])
    ...
    def hash
      [template_type, subject, html_body, text_body].hash
    end
