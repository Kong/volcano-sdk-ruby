...
module Volcano::Generated
  class FunctionDeployment < ApiModelBase
    attr_accessor :id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Volcano::Generated::FunctionDeployment` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Volcano::Generated::FunctionDeployment`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      operation_validator = EnumAttributeValidator.new('String', ["deploy", "update", "delete"])
      return false unless operation_validator.valid?(@operation)
      return false if @status.nil?
      status_validator = EnumAttributeValidator.new('String', ["queued", "provisioning", "active", "failed", "superseded", "deleting", "deleted"])
    ...
    def operation=(operation)
      validator = EnumAttributeValidator.new('String', ["deploy", "update", "delete"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["queued", "provisioning", "active", "failed", "superseded", "deleting", "deleted"])
