...
module Volcano::Generated
  class FunctionHTTPAuthMode
    VOLCANO = "volcano".freeze
    NONE = "none".freeze

    def self.all_vars
      @all_vars ||= [VOLCANO, NONE].freeze
    end
    ...
    def build_from_hash(value)
      return value if FunctionHTTPAuthMode.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #FunctionHTTPAuthMode"
    end
  end
end
