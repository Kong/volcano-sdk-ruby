...
module Volcano::Generated
  class ImportProvider
    ImportProviderVercel = "vercel".freeze

    def self.all_vars
      @all_vars ||= [ImportProviderVercel].freeze
    end
    ...
    def build_from_hash(value)
      return value if ImportProvider.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ImportProvider"
    end
  end
end
