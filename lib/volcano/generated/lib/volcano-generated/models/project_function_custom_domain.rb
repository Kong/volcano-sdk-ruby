...
module Volcano::Generated
  class ProjectFunctionCustomDomain < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'target_type' => :'String',
        :'function' => :'ProjectFunctionCustomDomainAllOfFunction'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Volcano::Generated::ProjectFunctionCustomDomain` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Volcano::Generated::ProjectFunctionCustomDomain`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      target_type_validator = EnumAttributeValidator.new('String', ["function"])
    ...
    def hash
      [function_id, domain, tls_mode, domain_status, verification_status, verification_records, required_routing_record, effective_urls, created_at, updated_at, target, target_type, function].hash
    end
