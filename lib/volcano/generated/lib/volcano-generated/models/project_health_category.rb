...
module Volcano::Generated
  class ProjectHealthCategory
    ...
    def self.all_vars
      @all_vars ||= [LIFECYCLE, STORAGE].freeze
    end
    ...
    def build_from_hash(value)
      return value if ProjectHealthCategory.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ProjectHealthCategory"
    end
  end
end
