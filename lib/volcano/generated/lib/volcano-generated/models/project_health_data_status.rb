...
module Volcano::Generated
  class ProjectHealthDataStatus
    ...
    def self.all_vars
      @all_vars ||= [COMPLETE, PARTIAL, NO_DATA, STALE].freeze
    end
    ...
    def build_from_hash(value)
      return value if ProjectHealthDataStatus.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ProjectHealthDataStatus"
    end
  end
end
