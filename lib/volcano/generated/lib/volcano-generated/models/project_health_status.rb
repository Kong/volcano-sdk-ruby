...
module Volcano::Generated
  class ProjectHealthStatus
    ...
    def self.all_vars
      @all_vars ||= [HEALTHY, DEGRADED, CRITICAL, UNKNOWN].freeze
    end
    ...
    def build_from_hash(value)
      return value if ProjectHealthStatus.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ProjectHealthStatus"
    end
  end
end
