  ...
  class ProjectImportRun < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Volcano::Generated::ProjectImportRun` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Volcano::Generated::ProjectImportRun`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'destination_project_name')
        self.destination_project_name = attributes[:'destination_project_name']
      else
        self.destination_project_name = nil
      end
    ...
    def list_invalid_properties
      ...
      if @destination_project_name.nil?
        invalid_properties.push('invalid value for "destination_project_name", destination_project_name cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @destination_project_name.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] destination_project_name Value to be assigned
    def destination_project_name=(destination_project_name)
      if destination_project_name.nil?
        fail ArgumentError, 'destination_project_name cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          destination_project_name == o.destination_project_name &&
          resource == o.resource &&
    ...
    def hash
      [id, provider, source_id, destination_project_name, resource, deployment, status, error_code, error_message, created_at, updated_at].hash
    end
