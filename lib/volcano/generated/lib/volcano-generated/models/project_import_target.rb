...
module Volcano::Generated
  class ProjectImportTarget
    ProjectImportTargetProduction = "production".freeze

    def self.all_vars
      @all_vars ||= [ProjectImportTargetProduction].freeze
    end
    ...
    def build_from_hash(value)
      return value if ProjectImportTarget.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ProjectImportTarget"
    end
  end
end
