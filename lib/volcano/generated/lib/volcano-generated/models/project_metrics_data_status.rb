...
module Volcano::Generated
  class ProjectMetricsDataStatus
    COMPLETE = "complete".freeze
    PARTIAL = "partial".freeze
    NO_DATA = "no_data".freeze

    def self.all_vars
      @all_vars ||= [COMPLETE, PARTIAL, NO_DATA].freeze
    end
    ...
    def build_from_hash(value)
      return value if ProjectMetricsDataStatus.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ProjectMetricsDataStatus"
    end
  end
end
