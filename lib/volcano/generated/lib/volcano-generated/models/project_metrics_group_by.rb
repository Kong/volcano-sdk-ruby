...
module Volcano::Generated
  class ProjectMetricsGroupBy
    REGION = "region".freeze
    RESOURCE_TYPE = "resource_type".freeze

    def self.all_vars
      @all_vars ||= [REGION, RESOURCE_TYPE].freeze
    end
    ...
    def build_from_hash(value)
      return value if ProjectMetricsGroupBy.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ProjectMetricsGroupBy"
    end
  end
end
