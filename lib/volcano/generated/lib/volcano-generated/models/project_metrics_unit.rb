...
module Volcano::Generated
  class ProjectMetricsUnit
    COUNT = "count".freeze
    RATIO = "ratio".freeze
    SECONDS = "seconds".freeze

    def self.all_vars
      @all_vars ||= [COUNT, RATIO, SECONDS].freeze
    end
    ...
    def build_from_hash(value)
      return value if ProjectMetricsUnit.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ProjectMetricsUnit"
    end
  end
end
